...
(function($) {
  ...
  var persianDatepicker = (function() {
    function persianDatepicker(element, userOptions) {
      ...
      self.headerStyle = "style='height:" + (_ch+10) + "px;line-height:" + _ch + "px; font-size:" + (_fontSize + 4) + "px;' ";
      self.selectUlStyle = "style='background: rgb(191, 220, 248); margin-top:" + _ch + "px;height:" + (_ch * 7 - 30) + "px; font-size:" + (_fontSize - 2) + "px; left:0px' ";
      self.selectMonthLiStyle = "style='height:" + (_ch * 7 + 10) / (6) + "px;line-height:" + (_ch * 7 + 10) / (6) + "px; width:" + (6.7 * _cw) / (3) + "px;width:" + (6.7 * _cw) / (3) + "px\\9;' ";
      self.selectYearLiStyle = "style='height:" + (_ch * 7 + 10) / (6) + "px;line-height:" + (_ch * 7 + 10) / (6) + "px; width:" + (6.6 * _cw - 14) / (3) + "px; width:" + (6.6 * _cw - 15) / (3) + "px\\9;' ";
      self.footerStyle = "style='height:" + (_ch + 14) + "px; padding:7px;line-height:" + _ch + "px; font-size:" + _fontSize + "px;' ";
    ...
    persianDatepicker.prototype = {
      ...
      header: function() {
        ...
        _head.appendTo(this.calendar);
          _next = $('<div class="nextArrow"><i class="icofont-2x icofont-bubble-right"></div>')
...
*/
            //  از سال 1380 است تا 1410 را نمایش بدهد
            b = 1380;
            a = 1411;
        ...
        */
        ...
        _head.append(titleYearMonth);
          _prev = $('<div class="prevArrow"><i class="icofont-2x icofont-bubble-left"></div>')
      ...
      footer: function() {
        ...
        if (self.options.selectableMonths._indexOf(self.persianDate.month) > -1) {
            _goToday = $('<a class="goToday btn_Pill btn_Blue " />');
