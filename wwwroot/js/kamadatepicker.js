...
function kamaDatepicker(elementID, opt) {
    ...
    if (options.swapNextPrev)
        titleDiv.append("<button id='bd-prev-" + elementID + "' class='bd-prev' type='button' data-bs-toggle='tooltip' data-bs-title='ماه قبلی' data-toggle='tooltip'><span>قبلی</span></button>");
    else
        titleDiv.append("<button id='bd-next-" + elementID + "' class='bd-next' type='button' data-bs-toggle='tooltip' data-bs-title='ماه بعدی' data-toggle='tooltip'><span>بعدی</span></button>");
